...
public class ListControllerDriver {
    ...
    private static void printInfo() {
        ...
        sb.append("10: void addSong(int id, String title, String artist)\n");
        sb.append("11: void removeSong(int id, String title, String artist)\n");
        sb.append("12: void removeSong(int id, int pos)\n");
        sb.append("13: void swapSongs(int id, int pos1, int pos2)\n");
        sb.append("14: boolean containsSong(int id, String title, String artist)\n");
        sb.append("15: int listSize(int id)\n");
        sb.append("16: int getListDuration(int id)\n");
        sb.append("17: List getList(int id)\n");
        sb.append("18: String getListString(int id)\n");
